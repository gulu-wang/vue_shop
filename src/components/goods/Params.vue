...
<!--                    级联选择框-->
            ...
            <el-tabs v-model="activeName" @tab-click="handleTabsClick">
                <el-tab-pane label="动态参数" name="many">
                    <el-button type="primary" size="mini" :disabled="isBtnDisabled" @click="addParamsTanKuangIsShow=true">动态参数</el-button>
<!--                    动态数据表格-->
                ...
                <el-tab-pane label="静态属性" name="only">
                    <el-button type="primary" size="mini" :disabled="isBtnDisabled" @click="addParamsTanKuangIsShow=true"> 静态属性</el-button>
